...
#'
#' @param opt.list a list specifying the stopping criteria and the algorithm for the underlying optimizer \code{\link{nloptr}} for point estimation.
#' See the \strong{Details} section for more. 
#' 
...
#' 
#' @return
#' \item{data}{object containing used data and some other values.}
#' \item{est.results}{object containing all the estimation results.}
#'
#' @details
#' \itemize{
...
scest <- function(data,
  ...
  if (out.in.features == TRUE) {
    fit.pre  <- A.hat[1:T0.features[1], , drop= F]
